...
class QuiverSignals:
    ...
    CORE_STRATEGIES = {
        "Congress Buys": {
            ...
            "api_status": "requires_quiver_api",
        ...
        "Michael Burry": {
            ...
            "api_status": "works_via_sec_edgar",
    ...
    EXPERIMENTAL_STRATEGIES = {
        ...
        "Stanley Druckenmiller": {
            "description": "Mirrors Stanley Druckenmiller's Duquesne Family Office portfolio using SEC 13F filings; rebalanced quarterly when new filings are reported. Macro-driven, concentrated positions. CINS/foreign-issuer CUSIPs resolved via OpenFIGI fallback.",
            "category": "experimental",
            "subcategory": "Hedge Fund Manager",
            "api_status": "sec_edgar",
        ...
        "David Tepper": {
            "description": "Mirrors David Tepper's Appaloosa Management portfolio using SEC 13F filings; rebalanced quarterly when new filings are reported. Diversified macro and credit-adjacent positions.",
            "category": "experimental",
            "subcategory": "Hedge Fund Manager",
            "api_status": "sec_edgar",
            "start_date": "2016-01-01",
        ...
        "Seth Klarman": {
            "description": "Mirrors Seth Klarman's Baupost Group portfolio using SEC 13F filings; rebalanced quarterly when new filings are reported. Deep-value, distressed and special-situations focus.",
            "category": "experimental",
            "subcategory": "Hedge Fund Manager",
            "api_status": "sec_edgar",
            "start_date": "2016-01-01",
        ...
        "Mohnish Pabrai": {
            "description": "Mirrors Mohnish Pabrai's Pabrai Investment Funds portfolio using SEC 13F filings; rebalanced quarterly when new filings are reported. Extremely concentrated deep-value, long-hold style.",
            "category": "experimental",
            "subcategory": "Hedge Fund Manager",
            "api_status": "sec_edgar",
            "start_date": "2016-01-01",
        ...
        "Li Lu": {
            "description": "Mirrors Li Lu's Himalaya Capital portfolio using SEC 13F filings; rebalanced quarterly when new filings are reported. Extremely concentrated (often 2-3 positions); heavy China/emerging market exposure.",
            "category": "experimental",
            "subcategory": "Hedge Fund Manager",
            "api_status": "sec_edgar",
            "start_date": "2016-01-01",
        ...
        "Chuck Akre": {
            "description": "Mirrors Chuck Akre's Akre Capital Management portfolio using SEC 13F filings; rebalanced quarterly when new filings are reported. High-quality compounders, low-turnover.",
            "category": "experimental",
            "subcategory": "Hedge Fund Manager",
            "api_status": "sec_edgar",
            "start_date": "2016-01-01",
        ...
        "Warren Buffett": {
            "description": "Mirrors Warren Buffett's Berkshire Hathaway portfolio using SEC 13F filings; rebalanced quarterly when new filings are reported. Value-oriented, concentrated blue-chip holdings.",
            "category": "experimental",
            "subcategory": "Hedge Fund Manager",
            "api_status": "sec_edgar",
            "start_date": "2016-01-01",
        ...
        "David Einhorn": {
            "description": "Mirrors David Einhorn's Greenlight Capital portfolio using SEC 13F filings; rebalanced quarterly when new filings are reported. Value + short-selling thesis, concentrated positions.",
            "category": "experimental",
            "subcategory": "Hedge Fund Manager",
            "api_status": "sec_edgar",
            "start_date": "2016-01-01",
        ...
        "Dan Loeb": {
            "description": "Mirrors Dan Loeb's Third Point LLC portfolio using SEC 13F filings; rebalanced quarterly when new filings are reported. Event-driven activist, diversified macro.",
            "category": "experimental",
            "subcategory": "Hedge Fund Manager",
            "api_status": "sec_edgar",
            "start_date": "2016-01-01",
        ...
        "Tiger Global": {
            "description": "Mirrors Tiger Global Management portfolio using SEC 13F filings; rebalanced quarterly when new filings are reported. Growth/tech focused, high beta.",
            "category": "experimental",
            "subcategory": "Hedge Fund Manager",
            "api_status": "sec_edgar",
            "start_date": "2016-01-01",
        ...
        "Coatue": {
            "description": "Mirrors Coatue Management portfolio using SEC 13F filings; rebalanced quarterly when new filings are reported. Tech-concentrated growth, high beta; strong bull-market performance.",
            "category": "experimental",
            "subcategory": "Hedge Fund Manager",
            "api_status": "sec_edgar",
            "start_date": "2016-01-01",
        ...
        "Sequoia Fund": {
            "description": "Mirrors Sequoia Fund portfolio using SEC 13F filings; rebalanced quarterly when new filings are reported. Long-term concentrated value, Berkshire-adjacent style.",
            "category": "experimental",
            "subcategory": "Hedge Fund Manager",
            "api_status": "sec_edgar",
            "start_date": "2016-01-01",
        ...
        "Off-Exchange Short Squeeze": {
            "description": "Selects top 20 stocks by off-exchange short volume ratio from FINRA CNMS data; equal-weighted; weekly rebalancing with 5-day lookback. Low beta, uncorrelated alpha source.",
            "category": "experimental",
            "subcategory": "Alternative Data",
            "api_status": "finra_direct",
        ...
        "Off-Exchange Short Squeeze (Monthly)": {
            "description": "Selects top 20 stocks by off-exchange short volume ratio from FINRA CNMS data; equal-weighted; monthly rebalancing with 21-day lookback. Lower turnover and cost drag vs. weekly variant.",
            "category": "experimental",
            "subcategory": "Alternative Data",
            "api_status": "finra_direct",
            "start_date": "2018-10-01",
        ...
        "SMB Factor Regime": {
            "description": "Long-only ETF rotation between IWN (Russell 2000 Value) and IWD (Russell 1000 Value) based on an SMB regime signal. Logistic Regression trained on Fama-French data (1926–2010), deployed in real-time via IWM−SPY proxy (corr=0.91). SMB ON → IWN (market + size + value); OFF → IWD (market + value). Monthly rebalancing. No Quiver API required.",
            "category": "factor",
            "subcategory": "Factor Strategy",
            "api_status": "factor_data",
            ...
            "alpha": 0.018,
            "sharpe": 0.65,
            "research_url": "http://100.67.188.93:8770/artifact/0ea1ff50-ccb4-41fd-ae50-e3129bedd913"
        },
        "Value Large-Cap (IWD)": {
            "description": "Permanently holds IWD (iShares Russell 1000 Value ETF). Captures market + large-cap value premium. No signal, no rebalancing beyond dividend reinvestment. Useful as a passive value benchmark — outperforms SPY on Sharpe over full history.",
            "category": "factor",
            "subcategory": "Factor Strategy",
            "api_status": "factor_data",
            "start_date": "2000-08-01",
        ...
        "Value Small-Cap (IWN)": {
            "description": "Permanently holds IWN (iShares Russell 2000 Value ETF). Captures market + small-cap + value premium. No signal, no rebalancing. More volatile than IWD; strongest in small-cap regime cycles. Useful as a passive size+value benchmark.",
            "category": "factor",
            "subcategory": "Factor Strategy",
            "api_status": "factor_data",
            "start_date": "2000-08-01",
