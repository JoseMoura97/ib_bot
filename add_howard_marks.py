"""Add Howard Marks strategy to plot_data.json."""
import json
import os
...
print("=" * 80)
print("Adding Howard Marks to plot_data.json")
print("=" * 80)
...
print(f"\nTotal strategies now: {len(plot_data['strategies'])}")
